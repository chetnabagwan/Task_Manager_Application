...
class TestManager :
    ...
    def test_view_all_users(self, mocker, caplog):
        ...
        mocker.patch('src.manager.manager_controllers.display_data')
        mocker.patch('src.manager.manager_controllers.tabulate')
    ...
    def test_assign_tasks_to_user(self,mocker,capsys,caplog):
        ...
        mocker.patch('src.manager.manager_controllers.Manager.view_all_users')
        mocker.patch('src.manager.manager_controllers.InputValidations.userid_validator', return_value = '1234')
        mocker.patch('src.manager.manager_controllers.InputValidations.task_name_validator', return_value = 'Learn Python')
        mocker.patch('src.manager.manager_controllers.InputValidations.task_desc_validator', return_value = 'Decorators and Generators')
        mocker.patch('src.manager.manager_controllers.InputValidations.date_validator',return_value = '10-12-2023')
        mocker.patch('src.manager.manager_controllers.InputValidations.task_category_validator',return_value = '1')
        mocker.patch('src.manager.manager_controllers.add_data')
    ...
    def test_view_status_of_assigned_tasks(self,mocker,caplog,capsys):
        ...
        mocker.patch('src.manager.manager_controllers.fetch_data', side_effect = [[], 'test_data'])
        mocker.patch('src.manager.manager_controllers.tabulate')
    ...
    def test_positive_update_status_of_assigned_task(self,mocker,caplog,capsys):
        ...
        mocker.patch('src.manager.manager_controllers.fetch_data',side_effect = ['test_data',(),'test_data2'])
        mocker.patch('src.manager.manager_controllers.tabulate')
        mocker.patch('src.manager.manager_controllers.InputValidations.taskid_validator')
        mocker.patch('src.manager.manager_controllers.InputValidations.task_status_validator')
        mocker.patch('src.manager.manager_controllers.update_data')
    ...
    def test_negative_update_status_of_assigned_task(self,mocker,caplog,capsys):
        ...
        mocker.patch('src.manager.manager_controllers.fetch_data',return_value = [])
